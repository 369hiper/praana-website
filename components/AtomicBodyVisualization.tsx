...
// Video component with cosmic fallback and click-to-play
    ...
    <>
      <div className="absolute inset-0 bg-black rounded-3xl overflow-hidden">
        {isPlaying && !videoError ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-[#020108] via-[#0a0520] to-[#040210] cursor-pointer group" onClick={handlePlayClick}>
            ...
            <div className="relative w-48 h-80 opacity-60 group-hover:opacity-80 transition-opacity duration-500">
              {/* Body glow */}
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
              <div className="w-20 h-20 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-[0_0_30px_rgba(20,184,166,0.5)]">
                 <svg className="w-8 h-8 text-white ml-2" fill="currentColor" viewBox="0 0 24 24">
                   <path d="M8 5v14l11-7z" />
                 </svg>
              </div>
              <p className="mt-4 text-white font-bold tracking-widest text-sm uppercase opacity-90 group-hover:text-praana-accent transition-colors">Explore Atomic Field</p>
            </div>
